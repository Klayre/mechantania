...
class MechBaseExit(DefaultExit):
    """
    ...
    def get_display_name(self, looker, **kwargs):
        defaultDispName = super(MechBaseExit, self).get_display_name(looker)
    ...
    def return_appearance(self, looker):
        appearanceString = super(MechBaseExit, self).return_appearance(looker)
